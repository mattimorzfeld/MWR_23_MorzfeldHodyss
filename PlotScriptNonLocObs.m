...
for xx = 1:4
    ...
    for kk=1:length(NeAll)
        Ne = NeAll(kk);
        if expType == "multiScale"
            filename = strcat('./NonLocObsResults/',expType,'_Results_PriorLoc_L1_', num2str(L(1)),'_L2_', num2str(L(3)),'_ObsDist_',num2str(ObsDist),'_R_',num2str(r),'_Ne_',num2str(Ne),'.mat');
        elseif expType == "NonStat"
            filename = strcat('./NonLocObsResults/',expType,'_Results_PriorLoc_ObsDist_',num2str(ObsDist),'_R_',num2str(r),'_Ne_',num2str(Ne),'.mat');
        else
            filename = strcat('./NonLocObsResults/',expType,'_Results_PriorLoc_L_',num2str(L),'_ObsDist_',num2str(ObsDist),'_R_',num2str(r),'_Ne_',num2str(Ne),'.mat');
        end
        load(filename,'rmse')
...
%     figure(1), hold on
    ...
    for kk=1:length(NeAll)
        Ne = NeAll(kk);
        if expType == "multiScale"
            filename = strcat('./NonLocObsResults/',expType,'_Results_FDLocSeq_L1_', num2str(L(1)),'_L2_', num2str(L(3)),'_ObsDist_',num2str(ObsDist),'_R_',num2str(r),'_Ne_',num2str(Ne),'.mat');
        elseif expType == "NonStat"
            filename = strcat('./NonLocObsResults/',expType,'_Results_FDLocSeq_ObsDist_',num2str(ObsDist),'_R_',num2str(r),'_Ne_',num2str(Ne),'.mat');
        else
            filename = strcat('./NonLocObsResults/',expType,'_Results_FDLocSeq_L_',num2str(L),'_ObsDist_',num2str(ObsDist),'_R_',num2str(r),'_Ne_',num2str(Ne),'.mat');
        end
        load(filename,'rmse')
        avg_rmse(kk)=mean(rmse);
    end
